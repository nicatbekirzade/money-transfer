...
import static com.example.userms.exception.constants.HttpResponseConstants.ERROR;
import static com.example.userms.exception.constants.HttpResponseConstants.ERRORS;
import static com.example.userms.exception.constants.HttpResponseConstants.ERROR_CODE;
import static com.example.userms.exception.constants.HttpResponseConstants.MESSAGE;
import static com.example.userms.exception.constants.HttpResponseConstants.PATH;
import static com.example.userms.exception.constants.HttpResponseConstants.STATUS;
...
public class GlobalExceptionHandler extends DefaultErrorAttributes {
    ...
    public final ResponseEntity<Map<String, Object>> handle(
        ...
        log.error("FORBIDDEN EXCEPTION {}", (Object[]) ex.getStackTrace());
    ...
    public final ResponseEntity<Map<String, Object>> handle(
        ...
        log.warn("Request argument is invalid {}", (Object[]) ex.getStackTrace());
        return ofType(request, HttpStatus.BAD_REQUEST, ex.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handle(
        ...
        List<ConstraintsViolationError> validationErrors = ex.getConstraintViolations()
                .stream()
                .map(error -> new ConstraintsViolationError(error.getPropertyPath().toString(), error.getMessage()))
